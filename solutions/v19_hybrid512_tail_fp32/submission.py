"""V19: V18 plus FP32 tail panels for n=512.
...
Tier 2b (n=512, batch>=16): double panel for tall panels, FP32 for tail panels.
...
std::vector<torch::Tensor> dispatch_qr(torch::Tensor A) {
    ...
    if (n <= 512 && batch >= 16) {
        ...
        bool has_fp32_panels = n <= 352 || n == 512;
        ...
        for (int j = 0; j < n; j += nb) {
            ...
            int m_panel = n - j;
            bool use_fp32_panel = n <= 352 || (n == 512 && m_panel <= 352);
